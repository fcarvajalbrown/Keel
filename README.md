...
<p align="center"><sub>DAW user? Get the <a href="https://github.com/fcarvajalbrown/Keel/releases/download/v0.7.0-beta/Keel-VST3-windows-0.7.0.zip">VST3 plugin (Windows)</a> or the <a href="https://github.com/fcarvajalbrown/Keel/releases/download/v0.7.0-beta/Keel-plugins-macos-0.7.0.zip">VST3 + AU plugin (macOS)</a>.</sub></p>
...
In one line: **make your own music with it for free, even as a pro selling your
own records; pay only if you run a business on it or charge clients with it.**
